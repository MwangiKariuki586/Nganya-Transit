...
export default function CrewLiveSessionScreen({
  sessionId,
}: CrewLiveSessionScreenProps) {
    ...
    <div className="page-container py-8 md:py-10 max-w-2xl space-y-5">
      ...
      <section className="rounded-[var(--radius-xl)] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-1 text-sm text-[var(--color-text-secondary)]">
              Tap once, push instantly. Last ping refreshes every 15 seconds
              while this screen stays open.
            </div>
          </div>
        ...
        {session.seats_left === 0 ? (
          <div className="mt-3 text-body-sm text-[var(--color-text-secondary)]">
            ...
            the session once the route clears.
          </div>
        ) : null}
      </section>
      ...
      <section className="rounded-[var(--radius-xl)] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-5">
        ...
        <div className="mt-3 text-sm text-[var(--color-text-secondary)]">
          If route direction changes hard, stop and restart is still the safer
          operational flow.
        </div>
      </section>
